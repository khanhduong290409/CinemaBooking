...
<footer class="footer">
    <div class="footer-advise">
        <div>
            <ul>
                <li><a href="${pageContext.request.contextPath}/contact#gioithieu">Giới Thiệu</a></li>
                <li><a href="${pageContext.request.contextPath}/contact#lienhe">LIÊN HỆ</a></li>
                <li><a href="${pageContext.request.contextPath}/contact#chinhsach">CHÍNH SÁCH</a></li>
                <li><a href="${pageContext.request.contextPath}/contact#huongdan">HƯỚNG DẪN</a></li>
            </ul>
        </div>
        <div class="advise-text">
            <p><small>Địa chỉ trụ sở: 3 Đ. Cầu Giấy, Ngọc Khánh, Đống Đa, Hà Nội, Việt Nam</small></p>
            <p><small>Giấy chứng nhận ĐKKD số: 0106633482 - Đăng ký lần đầu ngày 08/09/2014 tại Sở Kế hoạch và Đầu tư Thành phố Hà Nội</small></p>
        </div>
    </div>
